...
def map_form_to_rec(payload: dict) -> dict:
    ...
    Delegates to app.pipeline_steps.map_form — this is the canonical implementation.
    Kept here for backward compatibility: any module that already imports
    `map_form_to_rec` from pipeline.py continues to work without changes.
    """
    from app.pipeline_steps.map_form import map_form_to_rec as _canonical
