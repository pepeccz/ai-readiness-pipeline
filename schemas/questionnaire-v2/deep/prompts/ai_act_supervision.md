# DEEP Branch: ai_act_supervision

## Contexto que recibe el LLM
- Respuestas TRIAGE del cliente
- Respuestas bloques CORE relevantes
- Razón de activación: se detectó riesgo de uso de IA con supervisión humana insuficiente según AI Act

## Instrucciones
Generá 5-15 preguntas DE PROFUNDIZACIÓN sobre supervisión humana sobre decisiones IA y cumplimiento del AI Act que el cliente responderá async para alimentar el report sesión 2.
