# DEEP Branch: extraccion_conocimiento

## Contexto que recibe el LLM
- Respuestas TRIAGE del cliente
- Respuestas bloques CORE relevantes
- Razón de activación: el conocimiento clave está en personas (no en sistemas) y puede perderse

## Instrucciones
Generá 5-15 preguntas DE PROFUNDIZACIÓN sobre extracción y documentación de conocimiento tácito de expertos que el cliente responderá async para alimentar el report sesión 2.
