# DEEP Branch: ia_self_hosted

## Contexto que recibe el LLM
- Respuestas TRIAGE del cliente
- Respuestas bloques CORE relevantes
- Razón de activación: los requisitos de privacidad o regulación podrían requerir IA self-hosted

## Instrucciones
Generá 5-15 preguntas DE PROFUNDIZACIÓN sobre evaluación de IA on-premise o self-hosted: requisitos, costes, capacidad que el cliente responderá async para alimentar el report sesión 2.
