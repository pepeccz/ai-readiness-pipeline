# DEEP Branch: monitorizacion_log

## Contexto que recibe el LLM
- Respuestas TRIAGE del cliente
- Respuestas bloques CORE relevantes
- Razón de activación: no existe monitorización ni logging de las decisiones automatizadas del sistema IA

## Instrucciones
Generá 5-15 preguntas DE PROFUNDIZACIÓN sobre monitorización, logging de auditoría y trazabilidad de decisiones IA que el cliente responderá async para alimentar el report sesión 2.
