# DEEP Branch: politica_genai

## Contexto que recibe el LLM
- Respuestas TRIAGE del cliente
- Respuestas bloques CORE relevantes
- Razón de activación: no existe política interna de uso de IA generativa para empleados

## Instrucciones
Generá 5-15 preguntas DE PROFUNDIZACIÓN sobre política de uso de GenAI: usos permitidos, prohibiciones, comunicación, training que el cliente responderá async para alimentar el report sesión 2.
