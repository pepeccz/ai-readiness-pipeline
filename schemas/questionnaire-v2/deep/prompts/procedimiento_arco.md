# DEEP Branch: procedimiento_arco

## Contexto que recibe el LLM
- Respuestas TRIAGE del cliente
- Respuestas bloques CORE relevantes
- Razón de activación: no existe procedimiento documentado para gestionar derechos ARCO de titulares

## Instrucciones
Generá 5-15 preguntas DE PROFUNDIZACIÓN sobre procedimiento ARCO (Acceso, Rectificación, Cancelación, Oposición) con IA que el cliente responderá async para alimentar el report sesión 2.
